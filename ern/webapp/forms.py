...
class ConsentForm(forms.Form):
    q1 = forms.BooleanField(
        required=True,
        label="I have read and understood the information about the research project and I voluntarily agree to participate. I know whom to contact in case I have questions and I have been informed about my rights.",
    )
...
class DemographicsForm(forms.Form):
    ...
    age = forms.IntegerField(
        initial="", min_value=0, max_value=99, required=False, label="Age (leave blank if you prefer not to say)"
    )
